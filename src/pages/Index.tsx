...
const Index: React.FC = () => {
  ...
  const fullPageOthersViews = [
    'finances', 'finances_income', 'finances_expenses', 'finances_categories', 'finances_create_category',
    'finances_monthly_overview', 'finances_income_onboarding', 'finances_expense_onboarding',
    'finances_income_form', 'finances_income_form_step2',
    'finances_expense_form', 'finances_expense_form_step2',
    'finances_income_list', 'finances_expense_list'
  ];
  ...
  const isOthersFullPage = (activePage === 'Outros' || activePage === 'Nutrição') && fullPageOthersViews.includes(othersView);
  const isSidebarHidden = isStudyFullPage || isTaskFullPage || isOthersFullPage;
  ...
  const renderPage = () => {
    ...
    switch (activePage) {
      ...
      case 'Nutrição': return <Others {...commonProps} initialView="nutrition_dashboard" onViewChange={setOthersView} onOpenDetail={setFullScreenItem} />;
      case 'Outros': return <Others {...commonProps} onViewChange={setOthersView} onOpenDetail={setFullScreenItem} />;
