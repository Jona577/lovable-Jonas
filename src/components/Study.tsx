...
const Study: React.FC<StudyProps> = ({ isDarkMode, onOpenDetail, onViewChange }) => {
  ...
  const handleFinalizeSession = () => {
    // Session finish - Push remainder if elapsed more than 30s
    if (realtimeSessionSecondsAcc.current >= 30) {
      recordStudySessionDate(1);
    }
    realtimeSessionSecondsAcc.current = 0; // Reset as we closed the session.
  ...
  const renderVocabRevisionResult = () => {
    ...
    return (
      <div className="animate-fadeIn max-w-2xl mx-auto flex flex-col items-center text-center py-4">
        <div className="w-32 h-32 bg-slate-50 flex flex-col items-center justify-center rounded-[2.5rem] border-2 border-black mb-6 shadow-xl overflow-hidden relative">
          ...
          <span className="text-4xl font-black text-slate-800 z-10">{percentage}%</span>
        </div>
  ...
  const renderVocabulary = () => {
    return (
      <div className="animate-fadeIn max-w-5xl mx-auto">
          ...
          <div className="flex flex-col gap-6 mb-10">
            <div className="flex flex-row justify-center items-center gap-6">
              <button
                ...
                className={`py-5 px-12 rounded-2xl font-black text-sm transition-all border-black border-[#A855F7] ${vocabSubView === 'categories' ? 'bg-[#A855F7] text-white' : 'bg-white text-[#A855F7] hover:bg-[#A855F7]/5'}`}
              >
                Minhas Categorias
              </button>
              <button
                ...
                className={`py-5 px-12 rounded-2xl font-black text-sm transition-all border-black border-[#3B82F6] ${vocabSubView === 'create_category' ? 'bg-[#3B82F6] text-white' : 'bg-white text-[#3B82F6] hover:bg-[#3B82F6]/5'}`}
              >
                Criar Categoria
              </button>
            </div>
        ...
        <div className="bg-white rounded-[2.5rem] border-[1.5px] border-black p-10 shadow-sm min-h-[450px] relative overflow-hidden">
                      ...
                      >
                        ...
                        <div className="shrink-0 flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="bg-white/20 hover:bg-white/40 p-2 rounded-xl border border-white/10 opacity-0 group-hover:opacity-100 transition-all active:scale-95 relative"
                          ...
                          <button
                            ...
                            className="bg-white/20 hover:bg-white/40 p-2 rounded-xl border border-white/10 opacity-0 group-hover:opacity-100 transition-all active:scale-95"
                          ...
                          <div className="absolute -top-3 -right-3 flex items-center gap-1.5 z-20">
                            ...
                            {isFromActiveReview && item.flashcardFront && (
                              <button
                                ...
                                className="w-10 h-10 bg-white/20 text-white rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-all hover:bg-white/40 hover:scale-110 active:scale-95 border border-white/10 relative"
                                title="Revisar erros"
                              >
                            ...
                            {isFromActiveReview && (
                              <button
                                ...
                                className="w-10 h-10 bg-white/20 text-white rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-all hover:bg-white/40 hover:scale-110 active:scale-95 border border-white/10"
                            ...
                            <button
                              ...
                              className="w-10 h-10 bg-red-600 text-white rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-opacity hover:scale-110 active:scale-95 border-black border-white"
                              title="Excluir"
                            >
      ...
      <div className="flex-1 view-container" key={view}>
        {view === 'menu' && (
          <div className="flex-1 flex flex-col items-center justify-center gap-16">
            <button
              ...
              className="group w-64 aspect-square bg-[#4A69A2] rounded-[3rem] shadow-xl flex flex-col items-center justify-center transition-all duration-300 hover:scale-105 active:scale-95 hover:bg-black"
            >
              <svg className="w-14 h-14 text-white mb-4" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                {/* Cabeça */}
              ...
              <span className="text-2xl font-black text-white uppercase tracking-tighter">Estudar</span>
            </button>
                    ...
                    {reviewPendencies.map(p => (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          ...
                          >
                            <svg className={`w-4 h-4 transition-opacity ${p.completed ? 'text-black opacity-100' : 'text-black opacity-0 group-hover/check:opacity-100'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" />
                            </svg>
                          </button>
                ...
                {filteredBooks.map(book => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {!isFromStudyMaterialSelect && (
                        <button onClick={(e) => { e.stopPropagation(); setBookToDelete(book); }} className="absolute -top-3 -right-3 w-10 h-10 bg-red-600 rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transition-opacity hover:scale-110 active:scale-95 z-20 border-black border-white"><svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg></button>
                      )}
                      <div className={`w-11 h-11 bg-white/30 rounded-xl flex items-center justify-center shrink-0 border border-white/20 ${isFromStudyMaterialSelect ? 'ml-10' : ''}`}>
                        <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          {isPdfCard ? (
                      ...
                      <div key={field.label} className={`flex flex-col gap-2 ${isBlocked ? 'opacity-40 pointer-events-none' : ''}`}>
                        ...
                        <div className="flex flex-row items-start gap-3">
                          <select
                            ...
                            className="flex-1 p-4 border-2 border-black/10 rounded-xl font-bold text-slate-800 outline-none bg-white"
                          >
        ...
        {view === 'addReviewFlashcardBack' && (
          <div className="animate-fadeIn max-w-5xl mx-auto pt-10">
            ...
            <div className="bg-white border-black border-black rounded-[3rem] shadow-2xl relative overflow-hidden">
              ...
              <div className="bg-slate-50 border-t-2 border-black p-8 flex justify-center gap-6 rounded-b-[3rem]">
                <button
                  onClick={() => handleFinalizeStudyItem(false)}
                  className="bg-white text-black border-black border-black px-8 py-4 rounded-[2rem] font-black text-xl shadow-xl hover:scale-105 active:scale-95 transition-all"
                >
                  Salvar flash card
                </button>
                <button
                  onClick={() => handleFinalizeStudyItem(true)}
                  className="bg-black text-white px-12 py-4 rounded-[2rem] font-black text-xl shadow-2xl hover:scale-105 active:scale-95 transition-all shadow-black/20"
                >
                  Finalizar
                </button>
              </div>
            ...
            {(draggingImageId || resizingImage) && (
              <div
                ...
                style={{ cursor: draggingImageId ? 'move' : resizingImage ? `${resizingImage.corner}-resize` : 'default' }}
                onMouseMove={(e) => {
                  if (draggingImageId) {
        ...
        {view === 'sessionTimerActive' && (
          <div className="flex flex-col items-center justify-center gap-6 pt-2 animate-fadeIn">
            ...
            <div className="relative transition-all duration-500 flex items-center justify-center w-[300px] h-[300px]">
              ...
              <div className="flex flex-col items-center z-10">
                <span className="text-slate-400 font-black text-xs tracking-widest uppercase mb-2">Tempo Restante</span>
                <span className="font-bold text-slate-900 leading-none tabular-nums text-5xl">
                  {formatTime(timerSeconds)}
                </span>
                <span className="mt-3 px-4 py-1 bg-slate-100 text-slate-500 text-sm font-black rounded-full">
            ...
            <div className="flex items-center gap-4">
              <button
                onClick={() => {
                  if (!isTimerRunning) setStudySessionHasStarted(true);
                  setIsTimerRunning(!isTimerRunning);
                }}
                className="bg-[#4A69A2] hover:bg-black text-white px-7 py-3 rounded-2xl shadow-xl flex items-center gap-2 font-black text-base transition-all active:scale-95 min-w-[130px] justify-center"
              >
                {isTimerRunning ? (
                  <>
              ...
              <button
                ...
                className="bg-[#EF4444] hover:bg-black text-white p-3 rounded-2xl shadow-xl transition-all active:scale-95"
                title="Reiniciar"
              >
                <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="hover:bg-slate-200 active:scale-95 shadow-md bg-slate-100 text-zinc-600 px-6 py-3 rounded-2xl flex items-center gap-2 font-black text-base transition-all"
            ...
            <div className="flex flex-col items-center justify-center gap-4 pt-0 animate-fadeIn">
              ...
              <div className="relative flex items-center justify-center w-[260px] h-[260px]">
                ...
                <div className="flex flex-col items-center z-10">
                  ...
                  <span className="mt-3 px-4 py-1 text-white text-sm font-black rounded-full" style={{ backgroundColor: accentColor }}>
              ...
              <div className="flex items-center gap-4">
                <button
                  onClick={() => {
                    if (!pomodoroIsRunning) setStudySessionHasStarted(true);
                    setPomodoroIsRunning(r => !r);
                  }}
                  className="text-white px-7 py-3 rounded-2xl shadow-xl flex items-center gap-2 font-black text-base transition-all active:scale-95 min-w-[130px] justify-center"
                  style={{ backgroundColor: accentColor }}
                >
                  {pomodoroIsRunning ? (
                    <><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z" /></svg>Pausar</>
                  ) : (
                    <><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg>Iniciar</>
                  )}
                </button>
                ...
                <button
                  ...
                  className={`${pomodoroIsRunning
                    ...
                    } bg-slate-100 text-slate-700 px-6 py-3 rounded-2xl flex items-center gap-2 font-black text-base transition-all`}
